...
class ApplicantAcademicController {
    constructor() {
    ...
    getAll = async (req, res) => {
        try {
            ...
            const resData = await this.applicantAcademicService.showPage(page, limit, offset, { search });
    ...
    createOne = async (req, res) => {
        try {
            const resData = await this.applicantAcademicService.create(req.body);
...
module.exports = ApplicantAcademicController;
