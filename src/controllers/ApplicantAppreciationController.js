...
class ApplicantAppreciationController {
    constructor() {
    ...
    getAll = async (req, res) => {
        try {
            ...
            const resData = await this.applicantAppreciationService.showPage(page, limit, offset, { search });
    ...
    createOne = async (req, res) => {
        try {
            const resData = await this.applicantAppreciationService.create(req.body);
...
module.exports = ApplicantAppreciationController;
