...
class EmployeeJobdeskService {
    ...
    //     let todayPerformance = await this.employeeJobdeskDao.countRawGradeRange(startCurrentDate, endCurrentDate, { employee_id })
    //     let yesterdayPerformance = await this.employeeJobdeskDao.countRawGradeRange(startPastDate, endPastDate, { employee_id })
    ...
    //     const employeeJobdeskData = await this.employeeJobdeskDao.getStartEnd(startOfWeek, endOfWeek, { employee_id})
